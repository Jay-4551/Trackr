...
<svelte:head>
	<title>Trackr - Library</title>
</svelte:head>
<main>
    <div class="flex flex-col h-screen w-full items-center py-20 bg-[#0B090A]" style="">
        <div class="flex flex-row p-4 items-center w-5/6 justify-between rounded-sm bg-[#161A1D] border border-gray-600 font-semibold">
            <h2 class="text-3xl text-white">Your Library</h2>
            <div class=" flex text-[#E5383B] items-end h-full text-xl">
                <button class="flex flex-row items-end" data-modal-target="defaultModal" data-modal-toggle="defaultModal">
                 Filters <ChevronDown/>
                </button>
            </div>
        </div>
        <!-- Main modal -->
        <div id="defaultModal" tabindex="-1" aria-hidden="true" data-modal-placement="top-right" class="fixed top-0 left-50 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
            <div class="relative w-full h-full max-w-2xl md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button data-modal-hide="defaultModal" type="button" class="text-white bg-[#E5383B] hover:bg-red-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Apply Filters</button>
        ...
        <div class="flex flex-row h-[50vh] w-5/6 rounded-sm bg-[#161A1D] border border-gray-600 font-semibold my-10">
            <h2 class="text-3xl text-white self-center m-auto">Add Games To Your Library!</h2> 
        </div>
        <div class="flex flex-row w-5/6 justify-end">
            <button class="rounded-sm py-2 px-4 bg-[#161A1D] hover:bg-[#BA181B] duration-300 border border-red-500 text-white text-3xl font-semibold self-end">
                Add Game +
            </button>
        </div>
    </div>
